...
export const shapeData = {
    ...
    { id: 'flow-triangle', name: 'Triangle', icon: { viewBox: '0 0 100 86.6', path: 'M50 0 L100 86.6 H0 Z' }, anchors: [ {x:50,y:0},{x:100,y:86.6},{x:0,y:86.6},{x:75,y:43.3},{x:25,y:43.3} ], getHandles: () => [
        { id: 'top', position: Position.Top, style: { top: '0%', left: '50%', transform: 'translate(-50%, 0%)' } },
        { id: 'bottom-left', position: Position.Bottom, style: { top: '100%', left: '25%', transform: 'translate(-50%, -100%)' } },
        { id: 'bottom-right', position: Position.Bottom, style: { top: '100%', left: '75%', transform: 'translate(-50%, -100%)' } },
        { id: 'left', position: Position.Left, style: { top: '50%', left: '0%', transform: 'translate(0%, -50%)' } },
        { id: 'right', position: Position.Right, style: { top: '50%', left: '100%', transform: 'translate(-100%, -50%)' } },
      ] },
    ...
    { id: 'flow-right-arrow', name: 'Right Arrow', icon: { viewBox: '0 0 100 60', path: 'M0 20 H70 L70 0 L100 30 L70 60 V40 H0 Z' }, anchors: [ {x:0,y:30},{x:70,y:30},{x:100,y:30},{x:70,y:0},{x:70,y:60} ], getHandles: () => [
        { id: 'left', position: Position.Left, style: { top: '50%', left: '0%', transform: 'translate(0%, -50%)' } },
        { id: 'right', position: Position.Right, style: { top: '50%', left: '100%', transform: 'translate(-100%, -50%)' } },
        { id: 'top', position: Position.Top, style: { top: '0%', left: '70%', transform: 'translate(-50%, 0%)' } },
        { id: 'bottom', position: Position.Bottom, style: { top: '100%', left: '70%', transform: 'translate(-50%, -100%)' } },
      ] },
...
// Export a flattened array of all shapes for easy lookup by ID
export const shapes = Object.values(shapeData).flat();