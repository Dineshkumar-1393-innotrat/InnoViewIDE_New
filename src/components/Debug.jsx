...
import { runCode, stepInto, stepOver, restart, stop } from '../features/debug/debugSlice';
  ...
  return (
    ...
    >
      ...
      <Flex justify="space-between" pt={2}>
        <Button variant="outline" leftIcon={<MdPlayArrow />} size="xs" onClick={() => dispatch(runCode(code))} />
        <Button variant="outline" leftIcon={<RiRestartLine />} size="xs" onClick={() => dispatch(restart())} />
        <Button variant="outline" leftIcon={<MdArrowDownward />} size="xs" onClick={() => dispatch(stepInto())} />
        <Button variant="outline" leftIcon={<MdArrowUpward />} size="xs" onClick={() => dispatch(stepOver())} />
        <Button variant="outline" leftIcon={<MdRefresh />} size="xs" onClick={() => dispatch(restart())} />
        <Button variant="outline" leftIcon={<MdStop />} size="xs" onClick={() => dispatch(stop())} />
      </Flex>
