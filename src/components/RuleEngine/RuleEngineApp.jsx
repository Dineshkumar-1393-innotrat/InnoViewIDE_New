...
const NAV_ITEMS = [
  ...
  { id: "create-project", label: "New Project", icon: Plus, group: "main" },
...
function DashboardScreen({
  ...
  return <div className="p-6 space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 w-full pt-2">
        ...
        <Btn className="h-10 px-4 shrink-0" onClick={() => setScreen("create-project")}>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div
          ...
          className="bg-card/40 border border-dashed border-border rounded-xl p-5 cursor-pointer hover:border-primary/40 hover:bg-card transition-all duration-200 flex flex-col items-center justify-center gap-2 min-h-[180px]"
        >
    ...
    rules.forEach((rule) => {
      ...
      if (rulePassed) {
        ...
        rule.actions.forEach((a) => {
          lines.push(`[${timestamp}]     Action Executed: ${a.type.toUpperCase()} → ${a.config}`);
        });
      }
    });
