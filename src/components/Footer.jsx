import { Box, HStack, VStack, Text, Link as ChakraLink, Icon, useColorMode } from "@chakra-ui/react";
    ...
    <Box as="footer" bg={bgColor} color={textColor} py={12} px={8}>
      <HStack spacing={12} justify="space-between">
        ...
        <VStack align="start" spacing={4}>
          <Text fontSize="2xl" fontWeight="bold">Innotrat Labs</Text>
          <Text maxW="300px">
          ...
          <HStack spacing={6} mt={6}>
            ...
            <ChakraLink href="https://www.facebook.com/InnotratLabs/" aria-label="Facebook" isExternal>
              <Icon as={FaFacebook} boxSize={7} />
            </ChakraLink>
            <ChakraLink href="https://x.com/i/flow/login?redirect_after_login=%2FInnotrat_Labs" aria-label="Twitter" isExternal>
              <Icon as={FaTwitter} boxSize={7} />
            </ChakraLink>
            <ChakraLink href="https://www.linkedin.com/company/innotrat-labs/" aria-label="LinkedIn" isExternal>
              <Icon as={FaLinkedin} boxSize={7} />
            </ChakraLink>
            <ChakraLink href="https://www.instagram.com/innotrat.labs/" aria-label="Instagram" isExternal>
              <Icon as={FaInstagram} boxSize={7} />
            </ChakraLink>
            <ChakraLink href="https://www.youtube.com/@innotratlabs" aria-label="YouTube" isExternal>
        ...
        <VStack align="start" spacing={3}>
          <Text fontSize="xl" fontWeight="bold">Information</Text>
          <Text>Contact</Text>
      ...
      <HStack justify="space-between" mt={16} pt={8} borderTop="1px solid" borderColor={borderColor}>
        <Text fontSize="md">Copyright © 2024 All rights reserved InnoIDE_V1Rev0_18Jan2025</Text>
        <HStack spacing={6}>
